        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationToken = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "AccessFailedCount", "CPF", "ConcurrencyStamp", "DataCadastro", "DataNascimento", "Email", "EmailConfirmationToken", "EmailConfirmed", "IsAtivo", "LockoutEnabled", "LockoutEnd", "NomeCompleto", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "Telefone", "Tipo", "TokenExpiration", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, null, "aa87e1b9-e1c1-4a9b-91c9-ae0000000000", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "admin@admin.com", "SEED-TOKEN", true, true, true, null, "Administrador do Sistema", "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAIAAYagAAAAEE79zlwOqw4NCdC2LZT+06FCYSO/r5wBVPgWj3KB6du/VXPzp7EDGVVl5Wtvcq+MjQ==", null, false, "d1f6e1d0-b321-4bdf-bb0a-bf0000000000", null, 1, new DateTime(2030, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, "admin@admin.com" });
